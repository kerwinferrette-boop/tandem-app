...
for (const fname of files) {
  ...
  L.push(`     intensity_tier, difficulty, tagline, description, coaching_notes,`);
  ...
  L.push(`     ${q(t.intensity_tier)}, ${q(t.difficulty)}, ${q(t.tagline)}, ${q(t.description)}, ${q(t.coaching_notes)},`);
  ...
  L.push(`    split_type = excluded.split_type, intensity_tier = excluded.intensity_tier,`);
