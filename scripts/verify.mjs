...
const CHECKS = [
  ...
  { name: 'program start smoke (BUG-93 — queue ownership, local dates, start-pointer reset, revert overdue)', run: () => execFileSync('node', [join(scriptsDir, 'program-start-smoke.mjs')], { stdio: 'inherit' }) },
